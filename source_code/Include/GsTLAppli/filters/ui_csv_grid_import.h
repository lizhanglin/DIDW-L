/********************************************************************************
** Form generated from reading UI file 'csv_grid_import.ui'
**
...
#ifndef UI_CSV_GRID_IMPORT_H
#define UI_CSV_GRID_IMPORT_H
...
public:
    ...
    void setupUi(QWidget *CsvGridImport)
    {
        if (CsvGridImport->objectName().isEmpty())
            CsvGridImport->setObjectName(QString::fromUtf8("CsvGridImport"));
        CsvGridImport->resize(338, 791);
        gridLayout = new QGridLayout(CsvGridImport);
        gridLayout->setSpacing(6);
        gridLayout->setContentsMargins(11, 11, 11, 11);
        gridLayout->setObjectName(QString::fromUtf8("gridLayout"));
        GroupBox1 = new QGroupBox(CsvGridImport);
        ...
        TextLabel1_2 = new QLabel(CsvGridImport);
        ...
        Line1_2 = new QFrame(CsvGridImport);
        ...
        groupBox5 = new QGroupBox(CsvGridImport);
        ...
        TextLabel1 = new QLabel(CsvGridImport);
        TextLabel1->setObjectName(QString::fromUtf8("TextLabel1"));
        ...
        Line1 = new QFrame(CsvGridImport);
        ...
        TextLabel4_4 = new QLabel(CsvGridImport);
        ...
        name_ = new QLineEdit(CsvGridImport);
        ...
        TextLabel1_2_2_2_2 = new QLabel(CsvGridImport);
        ...
        Line1_2_2_2_2 = new QFrame(CsvGridImport);
        ...
        TextLabel2_2 = new QLabel(CsvGridImport);
        TextLabel2_2->setObjectName(QString::fromUtf8("TextLabel2_2"));
        TextLabel2_2->setWordWrap(false);

        gridLayout->addWidget(TextLabel2_2, 6, 0, 1, 1);

        GroupBox1_2 = new QGroupBox(CsvGridImport);
        ...
        TextLabel1_2_2 = new QLabel(CsvGridImport);
        ...
        Line1_2_2 = new QFrame(CsvGridImport);
        ...
        GroupBox1_2_2 = new QGroupBox(CsvGridImport);
        ...
        TextLabel2 = new QLabel(CsvGridImport);
        ...
        retranslateUi(CsvGridImport);
        QObject::connect(use_no_data_value_, SIGNAL(toggled(bool)), NoDataValueBox, SLOT(setEnabled(bool)));

        QMetaObject::connectSlotsByName(CsvGridImport);
    } // setupUi

    void retranslateUi(QWidget *CsvGridImport)
    {
        CsvGridImport->setWindowTitle(QApplication::translate("CsvGridImport", "Grid Characteristics", 0, QApplication::UnicodeUTF8));
        GroupBox1->setTitle(QString());
        TextLabel4->setText(QApplication::translate("CsvGridImport", "Number of cells in X", 0, QApplication::UnicodeUTF8));
        TextLabel4_2->setText(QApplication::translate("CsvGridImport", "Number of cells in Y", 0, QApplication::UnicodeUTF8));
        TextLabel4_3->setText(QApplication::translate("CsvGridImport", "Number of cells in Z", 0, QApplication::UnicodeUTF8));
        TextLabel1_2->setText(QApplication::translate("CsvGridImport", "Cell Size", 0, QApplication::UnicodeUTF8));
        groupBox5->setTitle(QString());
        use_no_data_value_->setText(QApplication::translate("CsvGridImport", "Use No-Data-Value", 0, QApplication::UnicodeUTF8));
        NoDataValueBox->setTitle(QString());
        textLabel1->setText(QApplication::translate("CsvGridImport", "No-Data-Value:", 0, QApplication::UnicodeUTF8));
        TextLabel1->setText(QApplication::translate("CsvGridImport", "Grid Dimensions", 0, QApplication::UnicodeUTF8));
        TextLabel4_4->setText(QApplication::translate("CsvGridImport", "Grid name", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        name_->setToolTip(QApplication::translate("CsvGridImport", "name of new grid", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        TextLabel1_2_2_2_2->setText(QApplication::translate("CsvGridImport", "No Data Value", 0, QApplication::UnicodeUTF8));
        TextLabel2_2->setText(QApplication::translate("CsvGridImport", "The dimensions of a single cell", 0, QApplication::UnicodeUTF8));
        GroupBox1_2->setTitle(QString());
        x_size_->setText(QApplication::translate("CsvGridImport", "1.0", 0, QApplication::UnicodeUTF8));
        y_size_->setText(QApplication::translate("CsvGridImport", "1.0", 0, QApplication::UnicodeUTF8));
        z_size_->setText(QApplication::translate("CsvGridImport", "1.0", 0, QApplication::UnicodeUTF8));
        TextLabel4_5->setText(QApplication::translate("CsvGridImport", "Size in X", 0, QApplication::UnicodeUTF8));
        TextLabel4_2_2->setText(QApplication::translate("CsvGridImport", "Size in Y", 0, QApplication::UnicodeUTF8));
        TextLabel4_3_2->setText(QApplication::translate("CsvGridImport", "Size in Z", 0, QApplication::UnicodeUTF8));
        TextLabel1_2_2->setText(QApplication::translate("CsvGridImport", "Origin Coordinates", 0, QApplication::UnicodeUTF8));
        GroupBox1_2_2->setTitle(QString());
        xmn_->setText(QApplication::translate("CsvGridImport", "0", 0, QApplication::UnicodeUTF8));
        TextLabel4_5_2_2->setText(QApplication::translate("CsvGridImport", "Oy", 0, QApplication::UnicodeUTF8));
        ymn_->setText(QApplication::translate("CsvGridImport", "0", 0, QApplication::UnicodeUTF8));
        TextLabel4_5_2_2_2->setText(QApplication::translate("CsvGridImport", "Oz", 0, QApplication::UnicodeUTF8));
        zmn_->setText(QApplication::translate("CsvGridImport", "0", 0, QApplication::UnicodeUTF8));
        TextLabel4_5_2->setText(QApplication::translate("CsvGridImport", "Ox", 0, QApplication::UnicodeUTF8));
        TextLabel2->setText(QApplication::translate("CsvGridImport", "The coordinates of the lower left corner of the grid", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class CsvGridImport: public Ui_CsvGridImport {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CSV_GRID_IMPORT_H
