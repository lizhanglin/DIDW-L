...
class GEOSTAT_DECL GsTL_filter {
...
class GEOSTAT_DECL Moving_average : public GsTL_filter<Window_neighborhood> {
...
class GEOSTAT_DECL Moving_variance : public GsTL_filter<Window_neighborhood> {
...
class GEOSTAT_DECL Functional_filter : public GsTL_filter<Window_neighborhood> {
...
class GEOSTAT_DECL Rasterized_filter : public GsTL_filter<Window_neighborhood> {
...
class GEOSTAT_DECL Sobel_weights {
...
class GEOSTAT_DECL Gaussian_kernel {
